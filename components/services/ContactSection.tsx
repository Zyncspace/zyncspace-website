              ...
              <>
                ...
                <form className="aetheris-contact-form" action={siteContact.formAction} method="POST">
                  ...
                  <div className="form-group" style={{ marginTop: 24 }}>
                    ...
                    <input type="email" id="partner-email" name="email" placeholder="you@company.com" required />
                  </div>
                  <button type="submit" className="btn btn-white btn-full">{c.contact.form.submitLabel}</button>
                </form>
              </>
            ) : (
              <>
      ...
      <header className="service-page-header">
        <div className="container">
          ...
          <p className="service-page-desc">
            Connect with our consulting team, product support, or partnership desk — we respond within one business day.
          </p>
        </div>
      </header>
