  ...
  switch (id) {
    case 'ai':
      return (
        <svg viewBox="0 0 80 64" fill="none" aria-hidden>
          ...
          <path
            d="M32 26 L40 26 M40 26 L48 26 M40 26 L40 34"
            stroke={stroke}
    ...
    case 'cloud':
      return (
        <svg viewBox="0 0 80 64" fill="none" aria-hidden>
          <path
            d="M16 44 L24 36 L40 36 L48 28 L64 28 L64 44 Z"
            stroke={stroke}
            strokeWidth={strokeWidth}
          />
          <path d="M24 36 L24 48 L56 48 L56 36" stroke={stroke} strokeWidth={strokeWidth} />
          <path
            d="M32 48 L32 52 M40 48 L40 52 M48 48 L48 52"
            stroke={stroke}
            strokeWidth={strokeWidth}
          />
    ...
    case 'security':
      return (
        <svg viewBox="0 0 80 64" fill="none" aria-hidden>
          <path
            d="M40 14 L58 22 L58 38 C58 48 40 54 40 54 C40 54 22 48 22 38 L22 22 Z"
            stroke={stroke}
            strokeWidth={strokeWidth}
          />
          <path
            d="M34 38 L38 42 L46 32"
            stroke={stroke}
            strokeWidth={strokeWidth}
            strokeLinecap="round"
    ...
    case 'agile':
      return (
        <svg viewBox="0 0 80 64" fill="none" aria-hidden>
          ...
          <path
            d="M40 18 L40 28 M36 22 L40 18 L44 22"
            stroke={stroke}
            strokeWidth={strokeWidth}
            strokeLinecap="round"
          />
    ...
    case 'scale':
      return (
        <svg viewBox="0 0 80 64" fill="none" aria-hidden>
          <path
            d="M20 48 L20 40 L28 40 L28 32 L36 32 L36 24 L44 24 L44 16 L52 16"
            stroke={stroke}
            strokeWidth={strokeWidth}
            strokeLinejoin="round"
          />
    ...
    case 'partnership':
      return (
        <svg viewBox="0 0 80 64" fill="none" aria-hidden>
          ...
          <path
            d="M20 48 C20 38 24 34 28 34 C32 34 36 38 40 42 C44 38 48 34 52 34 C56 34 60 38 60 48"
            stroke={stroke}
            strokeWidth={strokeWidth}
          />
